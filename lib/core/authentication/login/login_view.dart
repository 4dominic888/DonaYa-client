            ...
            child: Column(
              ...
              children: [
                ...
                _LoginField(
                  ...
                  onErrorSelectBloc: () => context.select((LoginBloc bloc) => bloc.state.email.displayError),
                ),
                ...
                _LoginField(
                  ...
                  onErrorSelectBloc: () => context.select((LoginBloc bloc) => bloc.state.password.displayError),
                  additionalWidget: InkWell(
                    ...
                    child: Text(
                      'Forgot Password?',
                      style: 
                      themeContext.textTheme.bodyMedium!.copyWith(
